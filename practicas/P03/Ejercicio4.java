...
public class Ejercicio4 {
    ...
    public static void main(String[] args) {
        ...
        while (numero != intento) {
            ...
            if (intento < numero) {// es la condicon de que el numero es menor
                System.out.println("\nNO HAS ACERTADO EL NUMERO ES MENOR. INTENTALO DE NUEVO:  \n");
            } else if (intento > numero) {//es la condicion de que el numero es mayor
                System.out.println("\nNO HAS ACERTADO EL NUMERO ES MAYOR. INTENTALO DE NUEVO:  \n");
            } else if (intento == numero) {// es la igualdad y con lo que se gana 
                System.out.println("\nFELICIDADES HAS ACERTADO " + intento);
            }
        }
